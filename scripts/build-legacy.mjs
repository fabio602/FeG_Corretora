...
copyFileSync(join(LEGACY, 'assets', 'index-D__W4v7C.js'),  join(DIST, 'assets', 'index-D__W4v7C.js'))
copyFileSync(join(LEGACY, 'assets', 'index-CL6FT56J.css'), join(DIST, 'assets', 'index-CL6FT56J.css'))
...
const ASSET_BLOCK = `  <script type="module" crossorigin src="/assets/index-D__W4v7C.js"></script>
  <link rel="preload" as="style" href="/assets/index-CL6FT56J.css">
  <link rel="stylesheet" crossorigin href="/assets/index-CL6FT56J.css">`
...
function injectHomeSchemas() {
  ...
  writeFileSync(p, html)
  console.log('✅ Home schemas: InsuranceAgency + Organization + WebSite')
}
injectHomeSchemas()

// ── 13. FAQ: H1 pré-renderizado + FAQPage schema ─────────────────────────────────
function injectFAQPrerender() {
  const p = join(DIST, 'perguntas-frequentes', 'index.html')
  if (!existsSync(p)) return
  let html = readFileSync(p, 'utf-8')
  if (!html.includes('"FAQPage"')) {
    const faqSchema = JSON.parse("{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"O que \u00e9 Seguro Garantia?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Seguro Garantia \u00e9 uma ap\u00f3lice emitida por uma seguradora que garante ao benefici\u00e1rio (contratante, \u00f3rg\u00e3o p\u00fablico ou credor) que o tomador (contratado, licitante ou devedor) vai cumprir suas obriga\u00e7\u00f5es. Se o tomador n\u00e3o cumprir, a seguradora indeniza o benefici\u00e1rio. \u00c9 diferente de seguro de danos: o objetivo \u00e9 garantir o cumprimento de uma obriga\u00e7\u00e3o, n\u00e3o cobrir acidentes ou perdas.\"}}, {\"@type\": \"Question\", \"name\": \"Qual a diferen\u00e7a entre Seguro Garantia e cau\u00e7\u00e3o em dinheiro?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Com cau\u00e7\u00e3o em dinheiro, a empresa deposita o valor exigido e o dinheiro fica bloqueado durante toda a vig\u00eancia do contrato. Com Seguro Garantia, a empresa paga apenas um pr\u00eamio (percentual sobre o valor garantido) e mant\u00e9m o capital dispon\u00edvel para o neg\u00f3cio. Para contratos longos e de alto valor, a diferen\u00e7a financeira \u00e9 muito significativa.\"}}, {\"@type\": \"Question\", \"name\": \"Qual a diferen\u00e7a entre Seguro Garantia e carta fian\u00e7a banc\u00e1ria?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"A carta fian\u00e7a banc\u00e1ria tamb\u00e9m \u00e9 aceita como garantia, mas ela consome o limite de cr\u00e9dito da empresa junto ao banco, o que pode impedir outros financiamentos. O Seguro Garantia n\u00e3o consome limite banc\u00e1rio e costuma ter pr\u00eamio menor do que os encargos cobrados pelos bancos. Para empresas que precisam manter cr\u00e9dito dispon\u00edvel, o Seguro Garantia \u00e9 estrategicamente mais vantajoso.\"}}, {\"@type\": \"Question\", \"name\": \"Em quantas horas a ap\u00f3lice de Seguro Garantia \u00e9 emitida?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Para contratos padr\u00e3o, emitimos em at\u00e9 2 horas ap\u00f3s o recebimento do edital ou contrato e das informa\u00e7\u00f5es da empresa. Contratos de valores elevados ou alta complexidade podem demandar um dia a mais para an\u00e1lise de risco pela seguradora. Urg\u00eancias s\u00e3o tratadas com prioridade. Fale conosco pelo WhatsApp.\"}}, {\"@type\": \"Question\", \"name\": \"Quais documentos s\u00e3o necess\u00e1rios para contratar o Seguro Garantia?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Na maioria dos casos, pedimos: CNPJ, contrato social, balan\u00e7o patrimonial dos \u00faltimos dois anos, DRE e o edital ou contrato objeto da garantia. Para empresas menores ou contratos de baixo valor, a documenta\u00e7\u00e3o pode ser simplificada. Tratamos cada caso individualmente.\"}}, {\"@type\": \"Question\", \"name\": \"O Seguro Garantia \u00e9 aceito em todos os \u00f3rg\u00e3os p\u00fablicos?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Sim. A Nova Lei de Licita\u00e7\u00f5es (14.133/21) prev\u00ea expressamente o Seguro Garantia como modalidade de garantia aceita em todo o setor p\u00fablico federal, estadual e municipal. Se algum edital estiver excluindo o Seguro Garantia indevidamente, isso pode ser questionado administrativamente.\"}}, {\"@type\": \"Question\", \"name\": \"O que acontece se a empresa n\u00e3o cumprir o contrato?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"A seguradora paga a indeniza\u00e7\u00e3o ao benefici\u00e1rio (contratante) at\u00e9 o limite da ap\u00f3lice. Depois, a seguradora tem o direito de cobrar esse valor da empresa tomadora. O Seguro Garantia n\u00e3o elimina a responsabilidade da empresa. Ele garante que o contratante receber\u00e1 a indeniza\u00e7\u00e3o.\"}}, {\"@type\": \"Question\", \"name\": \"Empresa pequena pode contratar Seguro Garantia?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Sim. Trabalhamos com empresas de todos os portes, desde MEIs at\u00e9 grandes corpora\u00e7\u00f5es. Para empresas menores, o Seguro Garantia pode ser ainda mais estrat\u00e9gico, pois abre portas para contratos que antes eram imposs\u00edveis por falta de capital para cau\u00e7\u00e3o.\"}}, {\"@type\": \"Question\", \"name\": \"O Seguro Garantia Judicial \u00e9 aceito em execu\u00e7\u00e3o fiscal?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Sim. O art. 835, III do CPC prev\u00ea o Seguro Garantia como modalidade de garantia em execu\u00e7\u00f5es. A Fazenda P\u00fablica (Receita Federal, SEFAZ, Prefeitura) \u00e9 obrigada a aceitar o Seguro Garantia em execu\u00e7\u00f5es fiscais, desde que o valor da ap\u00f3lice seja suficiente para cobrir o d\u00e9bito atualizado.\"}}, {\"@type\": \"Question\", \"name\": \"Voc\u00eas atendem fora de Boituva (SP)?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Atendemos todo o Brasil de forma 100% digital. Editais, contratos, documentos e ap\u00f3lices de Seguro Garantia s\u00e3o enviados eletronicamente. N\u00e3o \u00e9 necess\u00e1rio nenhum deslocamento. Fale conosco pelo WhatsApp e resolvemos tudo remotamente.\"}}]}")
    const tag = `  <script type="application/ld+json">\n${JSON.stringify(faqSchema, null, 2)}\n  </script>`
    html = html.replace('</head>', tag + '\n</head>')
  }
  if (!html.includes('<h1')) {
    const pre = `<div style="font-family:system-ui,sans-serif;padding:4rem 1.5rem 2rem;max-width:900px;margin:0 auto;"><h1 style="font-size:clamp(24px,3vw,38px);font-weight:800;color:#1C3A5E;line-height:1.2;margin:0 0 12px;">Perguntas Frequentes sobre Seguro Garantia</h1><p style="font-size:16px;color:#4B5563;line-height:1.65;">Tire suas dúvidas sobre prazos, custos, documentos e como funciona o Seguro Garantia.</p></div>`
