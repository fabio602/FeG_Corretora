...
copyFileSync(join(LEGACY, 'assets', 'index-CixCQ7I7.js'),  join(DIST, 'assets', 'index-CixCQ7I7.js'))
...
const ASSET_BLOCK = `  <script src="/scroll-top.js" defer></script>
  <script type="module" crossorigin src="/assets/index-CixCQ7I7.js"></script>
