...
copyFileSync(join(LEGACY, 'assets', 'index-oPmd4zEZ.js'),  join(DIST, 'assets', 'index-oPmd4zEZ.js'))
copyFileSync(join(LEGACY, 'assets', 'index-6QP7Y_Ri.css'), join(DIST, 'assets', 'index-6QP7Y_Ri.css'))
...
const ASSET_BLOCK = `  <script src="/scroll-top.js" defer></script>
  <script type="module" crossorigin src="/assets/index-oPmd4zEZ.js"></script>
  <link rel="preload" as="style" href="/assets/index-6QP7Y_Ri.css">
  <link rel="stylesheet" crossorigin href="/assets/index-6QP7Y_Ri.css">
