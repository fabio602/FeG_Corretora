...
copyFileSync(join(LEGACY, 'assets', 'index-BmEctUiT.js'),  join(DIST, 'assets', 'index-BmEctUiT.js'))
...
const ASSET_BLOCK = `  <script src="/scroll-top.js" defer></script>
  <script type="module" crossorigin src="/assets/index-BmEctUiT.js"></script>
