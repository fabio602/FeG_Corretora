...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .rich-title { font-family:'Lora',serif; font-size:16px; font-weight:700; color:var(--navy); line-height:1.35; flex:1; }
    ...
    .all-section-title { font-family:'Lora',serif; font-size:clamp(22px,3vw,30px); font-weight:700; color:var(--navy); margin-bottom:28px; }
