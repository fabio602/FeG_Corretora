...
copyFileSync(join(LEGACY, 'assets', 'index-Bhzvy-ks.js'),  join(DIST, 'assets', 'index-Bhzvy-ks.js'))
...
const ASSET_BLOCK = `  <script type="module" crossorigin src="/assets/index-Bhzvy-ks.js"></script>
