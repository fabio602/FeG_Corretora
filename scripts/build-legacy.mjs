...
copyFileSync(join(LEGACY, 'assets', 'index-DKp276rK.js'),  join(DIST, 'assets', 'index-DKp276rK.js'))
...
const ASSET_BLOCK = `  <script src="/scroll-top.js" defer></script>
  <script type="module" crossorigin src="/assets/index-DKp276rK.js"></script>
