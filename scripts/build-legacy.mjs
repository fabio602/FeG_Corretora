...
copyFileSync(join(LEGACY, 'assets', 'index-BxcItwNW.js'),  join(DIST, 'assets', 'index-BxcItwNW.js'))
...
const ASSET_BLOCK = `  <script src="/scroll-top.js" defer></script>
  <script type="module" crossorigin src="/assets/index-BxcItwNW.js"></script>
